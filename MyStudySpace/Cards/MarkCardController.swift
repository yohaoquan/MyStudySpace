...
class MarkCardController: CardPartsViewController {
    ...
    override func viewDidLoad() {
        ...
        descriptionCP.text = "Marks and Credits"
...
extension MarkCardController: RoundedCardTrait {
    func cornerRadius() -> CGFloat {
        return 10.0
    }
}

extension MarkCardController: GradientCardTrait {
