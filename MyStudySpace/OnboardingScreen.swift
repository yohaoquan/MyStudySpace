    ...
    func onboardingItem(at index: Int) -> OnboardingItemInfo {
        return [
         ...
         OnboardingItemInfo(informationImage: #imageLiteral(resourceName: "technical-support"),
                                  ...
                                  description: "We are always looking for ways to improve. Share your unique app experience with our team and help us stay in touch. If you encounter any errors or bugs, you can find us through the “contact us” in the settings, and then send us an error report. These reports can help us improve our application. Thank you very much for your help!",
        ...
        OnboardingItemInfo(informationImage: UIImage(named:"search")!,
                                     title: "More features",
                               description: "MyStudySpace has some handy links for Laurier Students, such as the commonly used Visual Schedule Builder, Loris, and MylearningSpace. Students could be accessed these links easily through this app...",
